function compute_intersection(arr1, arr2, callback){
	...
	//let's break up the bigger of the arrays
	...
	var sidx = 0;		// starting index of chunk
...
var a2 = [ 3476, 75347547, 2457634563, 56763472, 34574, 2347,
			...
			7582768, 284835, 8553577, 2577257,545634,
			457247247, 2345 ];

compute_intersection( a1, a2, function (err, results) {
	if (err) { console.log( err);
	} else { console.log( 'Intersection is: ' + results); 
	}
});